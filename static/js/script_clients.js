...
function toggleNavigation() {
    ...
    const menuExpendBtn = document.getElementById('menu-expend-button');
    
    nav.classList.toggle('mini-nav');
    
    if (nav.classList.contains('mini-nav')) {
        menuMiniBtn.style.display = 'none';
        menuExpendBtn.style.display = 'block';
        document.querySelector('.b-brand .logo-lg').style.display = 'none';
        document.querySelector('.b-brand .logo-sm').style.display = 'block';
    } else {
        menuMiniBtn.style.display = 'block';
        menuExpendBtn.style.display = 'none';
        document.querySelector('.b-brand .logo-lg').style.display = 'block';
