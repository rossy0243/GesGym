...
Cette note documente la couverture canonique des KPI. Elle ne decrit pas le stockage des medias ; pour les images et Backblaze B2, voir [MEDIA_STORAGE_GESGYM.md](D:/GesGym/docs/MEDIA_STORAGE_GESGYM.md).
